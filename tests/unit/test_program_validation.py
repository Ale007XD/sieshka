...
class TestADR001ExactlyOneTerminal:
    ...
    def test_request_payment_one_terminal(self):
    ...
    def test_payment_confirmation_one_terminal(self):
    ...
    def test_start_cooking_one_terminal(self):
...
class TestNoFailureTerminalIsWarning:
    ...
    def test_no_failure_terminal_severity_is_warning(self):
        """If a program triggers NO_FAILURE_TERMINAL, it must be WARNING."""
        programs = [PROGRAM_REQUEST_PAYMENT, PROGRAM_PAYMENT_CONFIRMATION,
                     PROGRAM_START_COOKING]
