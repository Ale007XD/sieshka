"""
app/programs/support_agent_program.py — nano-vm Program for SupportAgent.
...
PROGRAM_COLLECT_ORDER = Program(
    name="support_agent_collect",
    steps=[
        Step(
            id="process_input",
            type=StepType.LLM,
            prompt=(
                "You are a support processing assistant.\n"
                "Analyze the support input below and generate a structured command "
                "in JSON format.\n"
